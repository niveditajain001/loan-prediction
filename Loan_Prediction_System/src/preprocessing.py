...
def create_mock_data():
    ...
    data = {
        ...
        'LoanAmount': np.random.randint(100, 500, n), # Stored in thousands internally
    ...
    # Financial logic rule for synthetic target generation
...
def preprocess():
    ...
    print("✅ Preprocessing complete. Processed data and encoders/scaler saved.")
